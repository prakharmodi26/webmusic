...
export const drumKitConfig: InstrumentConfig = {
  ...
  pads: [
    // Top row - Cymbals (golden brass color)
    {
      ...
      soundFile: '/sounds/drums/crash.wav',
      color: '#D4A843',
      shape: 'cymbal',
    },
    {
      ...
      soundFile: '/sounds/drums/ride.wav',
      color: '#D4A843',
      shape: 'cymbal',
    },
    // Middle row - Main drums
    {
      ...
      soundFile: '/sounds/drums/snare.wav',
      color: '#CCCCCC',
      shape: 'drum',
    },
    {
      ...
      soundFile: '/sounds/drums/tom-low.wav',
      color: '#CCCCCC',
      shape: 'drum',
    },
    {
      ...
      soundFile: '/sounds/drums/tom-high.wav',
      color: '#CCCCCC',
      shape: 'drum',
    },
    ...
    },
    {
      ...
      soundFile: '/sounds/drums/hihat.wav',
      color: '#CCCCCC',
      shape: 'hihat',
    },
  ],
